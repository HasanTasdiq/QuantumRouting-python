...
def Run(numOfRequestPerRound = 20, numOfNode = 100, r = 7, q = 0.8, alpha = 0.0002, SocialNetworkDensity = 0.5, rtime = 150, topo = None, FixedRequests = None , results=[]):
...
if __name__ == '__main__':
    ...
    topo = Topo.generate(100, 0.8, 5, 0.0002, 4)
    jobs = []
