...
def Run(numOfRequestPerRound = 20, numOfNode = 100, r = 7, q = 0.8, alpha = 0.0002, SocialNetworkDensity = 0.5, rtime = 201, topo = None, FixedRequests = None , results=[]):
...
if __name__ == '__main__':
    ...
    numOfRequestPerRound = [20,25 , 30 , 35]
