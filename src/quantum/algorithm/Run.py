...
def Run(numOfRequestPerRound = 40, numOfNode = 50, r = 7, q = 0.8, alpha = 0.0002, SocialNetworkDensity = 0.5, rtime = 100, topo = None, FixedRequests = None , results=[]):
