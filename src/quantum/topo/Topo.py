...
class Topo:
    ...
    def generateRequest(self , numOfRequestPerRound):
        ...
        # ret10 = [(55, 87), (39, 91), (56, 93), (31, 62), (95, 49), (3, 64), (32, 15), (36, 33), (3, 72), (10, 41)] #10
        
        ret3 = [ (3, 2), (7, 6) , (2, 4)]
        ret4 = [(2,4) , (2,4) , (2,4) , (2,4)]
        # ret5 = [ (1,5) , (2, 6), (3, 8), (7, 2)  , (0 , 4)]
        ret5 = [(0,18) , (3,14) , (1,19) , (4,15) , (2,24)]
        ret10 = [(13, 0), (3, 5), (0, 4), (1, 4), (12, 0), (10, 5), (9, 15), (1, 3), (2, 5), (3, 10)] #for 4*4
        ret15 = [(22, 14), (0, 17), (10, 3), (17, 14), (7, 17), (17, 8), (3, 15), (22, 13), (13, 16), (13, 8), (6, 2), (2, 1), (12, 24), (13, 0), (15, 21)]
        ret15 = [(6, 13), (2, 14), (0, 15), (0, 13), (2, 3), (1, 5), (4, 10), (3, 11), (3, 7), (6, 14), (5, 10), (5, 15), (2, 6), (1, 3), (7, 8)] #16 nodes
        ret25 = [(5, 10), (14, 4), (19, 15), (6, 3), (13, 19), (17, 13), (3, 21), (9, 8), (7, 12), (23, 17), (0, 6), (16, 14), (18, 0),
                  (0, 20), (19, 7), (8, 6), (5, 9), (4, 17), (6, 8), (9, 18), (24, 8), (21, 14), (5, 17), (11, 15), (13, 3)]
        # ret20 = [(51, 53), (85, 22), (46, 70), (89, 99), (86, 94), (47, 11), (56, 84), (65, 13), (99, 20), (66, 50), (47, 62), (93, 3), (60, 5), (39, 90), (78, 75), (74, 50), (82, 21), (21, 64), (29, 1), (98, 25)]
        ret30 = [(80, 99), (56, 5), (26, 9), (40, 57), (84, 38), (14, 31), (86, 14), (24, 3), (24, 81), (17, 79), (76, 87), (85, 3), 
                 (56, 93), (3, 71), (29, 60), (22, 68), (1, 28), (17, 8), (2, 17), (41, 73), (10, 66), (69, 33), (24, 50), 
                 (1, 69), (35, 45), (33, 69), (49, 51), (67, 68), (59, 35), (11, 23)]
        ret40 = [(43, 47), (96, 70), (4, 81), (47, 74), (9, 62), (81, 10), (69, 57), (42, 64), (69, 0), (20, 41), (46, 27), (18, 74),
                  (18, 75), (13, 51), (40, 65), (53, 46), (43, 33), (77, 47), (4, 91), (8, 98), (80, 31), (33, 96), (50, 70), (36, 73),
                    (79, 10), (9, 90), (21, 34), (52, 10), (16, 36), (70, 92), (82, 33), (30, 26), (12, 35), (92, 61), (6, 94), (65, 38),
                      (26, 69), (9, 70), (40, 43), (37, 66)]
        ret50 = [(32, 67), (21, 84), (34, 82), (91, 37), (58, 89), (41, 63), (60, 14), (3, 39), (49, 43), (53, 24), (33, 13), (32, 93), 
                 (65, 26), (77, 55), (2, 28), (2, 50), (18, 4), (92, 20), (57, 90), (64, 86), (54, 69), (28, 80), (88, 66), (57, 28), 
                 (67, 83), (3, 50), (86, 73), (41, 84), (80, 54), (7, 94), (38, 16), (27, 6), (39, 9), (9, 39), (38, 95), (20, 53), 
                 (72, 32), (16, 1), (71, 4), (75, 27), (72, 58), (21, 99), (90, 79), (65, 4), (48, 25), (44, 12), (26, 73), (86, 55), 
                 (75, 24), (63, 13)]
        
        ret20 = [(5, 41), (36, 41), (21, 14), (24, 19), (2, 20), (11, 20), (37, 19), (15, 21), (6, 34), (39, 37), (38, 5), (15, 14), (1, 15), (25, 4), (17, 35), (4, 46), (4, 1), (40, 0), (18, 48), (22, 31)]
        
        # ret50 = [(19, 24), (21, 26), (12, 16), (6, 16), (46, 32), (13, 38), (27, 1), (14, 1), (25, 9), (2, 46), (10, 28), (45, 32), (43, 27), (34, 14), 
        #          (40, 44), (33, 28), (14, 33), (41, 1), (25, 43), (36, 20), (42, 40), (27, 3), (47, 19), (8, 13), (3, 19), (4, 19), (19, 47), (10, 26), 
        #          (36, 16), (8, 0), (35, 2), (37, 13), (36, 29), (10, 45), (39, 32), (2, 24), (12, 22), (6, 13),
        #           (36, 43), (27, 37), (12, 31), (6, 42), (24, 18), (32, 31), (1, 20), (39, 25), (18, 1), (10, 12), (20, 36), (8, 21)] #49 nodes
        
        ret100 = [(34, 145), (216, 205), (195, 16), (65, 30), (126, 194), (115, 120), (166, 97), (201, 53), (24, 124), (7, 213),
                   (99, 110), (155, 195), (196, 0), (178, 114), (68, 184), (205, 58), (151, 26), (81, 7), (5, 6), (166, 138), 
                   (2, 97), (175, 55), (108, 185), (7, 135), (56, 195), (112, 126), (141, 59), (88, 59), (173, 56), (194, 117), 
                   (74, 5), (106, 214), (142, 164), (25, 47), (161, 185), (220, 75), (30, 190), (85, 184), (182, 128), (108, 129), 
                   (212, 171), (48, 77), (72, 150), (127, 216), (129, 100), (150, 218), (8, 122), (62, 190), (204, 103), (106, 170), 
                   (44, 93), (140, 179), (198, 172), (188, 95), (22, 112), (169, 130), (27, 199), (41, 133), (215, 100), (94, 125),
                     (187, 7), (120, 11), (78, 180), (217, 157), (151, 148), (100, 165), (43, 128), (58, 3), (197, 51), (138, 220),
                       (140, 59), (103, 131), (88, 216), (147, 90), (117, 68), (168, 140), (155, 186), (1, 98), (200, 219), (210, 189),
                         (131, 207), (33, 132), (199, 143), (52, 109), (14, 123), (222, 93), (145, 141), (51, 129), (105, 124), 
                         (208, 91), (106, 88), (0, 137), (138, 159), (201, 156), (84, 117), (153, 7), (162, 45), (140, 149), (46, 220),
                           (23, 204)]
        ...
        # ret = [(0,2) , (1,3)]
        # ret = [(19, 24), (22, 15), (4, 18), (17, 24), (3, 10), (1, 13), (2, 12), (4, 10)]

        # ret = [(38, 37), (48, 33), (29, 9), (25, 32), (29, 5), (30, 28), (31, 20), (48, 26),(7,0) , (44,6)]
        # ret = [(2 , 25), (2,25),(2 , 25), (2,25),(2 , 25), (2,25),(2 , 25), (2,25),(2 , 25), (2,25)]
        # ret = [(2,25) ]
        return ret[numOfRequestPerRound]
